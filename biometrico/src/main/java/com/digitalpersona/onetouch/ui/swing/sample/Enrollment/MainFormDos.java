...
public class MainFormDos extends JFrame
{
	...
	MainFormDos() {
		...
		this.addPropertyChangeListener(TEMPLATE_PROPERTY, new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if (template != null)
					JOptionPane.showMessageDialog(MainFormDos.this, "The fingerprint template is ready for fingerprint verification.", "Fingerprint Enrollment", JOptionPane.INFORMATION_MESSAGE);
			}
		});
